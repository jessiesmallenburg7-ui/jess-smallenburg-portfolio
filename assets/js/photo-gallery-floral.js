/**
 * Floral gallery — edit this list to add or remove photos.
 *
 * To ADD a photo:
 *   1. Drop the full-resolution file in:
 *      assets/images/photography/floral/
 *   2. Add an object below:
 *      { file: "your-file.jpg", alt: "Short description", caption: "Optional title" }
 *
 * To REMOVE a photo:
...
window.PHOTO_GALLERY_FLORAL = [
  {
    file: "pale-pink-peony.jpg",
    alt: "Soft macro of pale pink peony petals spiraling toward the center",
    caption: "Pale pink peony",
  },
  {
    file: "lily.jpg",
    alt: "Yellow lily stamens in sharp focus against soft petals",
    caption: "Lily",
  },
  {
    file: "dahlia-garden.jpg",
    alt: "Dense garden of orange, yellow, and pink dahlias",
  ...
  },
  {
    ...
    alt: "Abstract macro of purple and pink passion flower petals",
